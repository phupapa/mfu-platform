...
export default function HeroVideoDialog({
  ...
  return (
    <div className={cn("relative", className)}>
      {/* Thumbnail */}
      <div
        className="group relative cursor-pointer max-w-md mx-auto h-[244px] border border-gray-300 shadow-xl rounded-lg"
        onClick={() => setIsVideoOpen(true)}
      >
        <img
          src={thumbnailSrc}
          alt={thumbnailAlt}
          width={1280} // Reduced width
        ...
        {isVideoOpen && (
          ...
          >
            <motion.div
              ...
              className="relative mx-4 aspect-video w-full max-w-lg md:mx-0"
            >
              {" "}
              {/* Reduced max width */}
              <motion.button className="absolute -top-10 right-0 rounded-full bg-neutral-900/50 p-2 text-xl text-white ring-1 backdrop-blur-md dark:bg-neutral-100/50 dark:text-black">
